...
class KbGlobal extends ObjectModel
{
    ...
    public static function getDefaultSettingsFirstTime($key = null)
    {
        ...
        $seller_order_email_template_default = "<table>
											...
											<span size='2' face='Open-sans, sans-serif' color='#555454' style='color: #555454; font-family: Open-sans, sans-serif; font-size: small;'><span style='color: #777;'>{delivery_point}</span> </span></td>
