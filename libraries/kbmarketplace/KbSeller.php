...
class KbSeller extends ObjectModel
{
    ...
    public static function getAllSellersTitle()
    {
        $sql = 'Select s.id_seller, sl.title AS seller_name from '
                . _DB_PREFIX_ . 'kb_mp_seller s '
                . 'LEFT JOIN `'._DB_PREFIX_.'kb_mp_seller_lang` sl'
                . ' ON (sl.`id_seller` = '. 's.`id_seller` '
                . 'AND sl.`id_lang`='.Context::getContext()->language->id.')';
