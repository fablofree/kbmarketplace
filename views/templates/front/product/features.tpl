...
<div class="kb-panel outer-border kb_product_section" >
    <div data-toggle="kb-product-form-features" class='kb-panel-header kb-panel-header-tab' style="display: none;" >
        <h1>{$form_title|escape:'htmlall':'UTF-8'}</h1>
        <div class='kb-accordian-symbol kbexpand'><i class="kb-material-icons">&#xe145;</i></div>
        <div class='clearfix'></div>
    </div>
    <div id="kb-product-form-features" class='kb-panel-body' style="display: none;">
        {if $id_product eq 0}
