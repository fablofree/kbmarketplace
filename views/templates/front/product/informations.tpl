            ...
            <ul class="kb-form-list">
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel ">{l s='Product Name' mod='kbmarketplace'}</span><em>*</em>
                    </div>
                ...
                <li class="kb-form-r">
                    <div class="kb-form-label-block">
                        <span class="kblabel "><i class="kb-material-icons" data-toggle="tooltip" data-placement="top" title="{l s='This info allows you to identify each of your product.' mod='kbmarketplace'}">info_outline</i>{l s='Product Reference Code' mod='kbmarketplace'}</span><em>*</em>
                    </div>
                    <div class="kb-form-field-block">
                ...
                <li class="kb-form-r" style="display: none;">
                    <div class="kb-form-label-block">
                ...
                <li class="kb-form-fwidth">
                    ...
                    <div class="kb-form-field-block">
                        <div class="kboption-inline kb-inpoption">
                            <input class="" type="hidden" id="label_for_available_order" name="available_for_order" value="1" {if $id_product > 0}{if $available_for_order}checked="checked"{/if}{else}checked="checked"{/if} /> <label for="label_for_available_order">{*l s='Available for order' mod='kbmarketplace'*}</label>    
                        </div>
                        <div class="kboption-inline kb-inpoption">
                            <input class="" type="hidden" id="label_for_show_price" name="show_price" value="1"  {if $show_price}checked="checked"{/if}  /> <label  for="label_for_show_price">{*l s='Show price' mod='kbmarketplace'*}</label>    
                        </div>
                        <div class="kboption-inline kb-inpoption" style="margin-bottom:0;">
                            <input class="" type="hidden" id="label_for_online_only" name="online_only" value="1" {if $online_only}checked="checked"{/if} /> <label  for="label_for_online_only">{*l s='Online only (not sold in your retail store)' mod='kbmarketplace'*}</label>    
                        </div>
                    </div>
                </li>
                <li class="kb-form-fwidth">
