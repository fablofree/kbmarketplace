            ...
            <ul class="kb-form-list">
                <li class="kb-form-l">
                    <div class="kb-form-label-block">
                        <span class="kblabel "><i class="kb-material-icons" data-toggle="tooltip" data-placement="top" title="{l s='Product Quantity can not be less than 1 or blank' mod='kbmarketplace'}">info_outline</i>{l s='Stock Quantity' mod='kbmarketplace'}</span>
                    </div>
              ...
              <!--  <li class="kb-form-r" style=" display: none;" >
                    ...
                    <div class="kb-form-field-block" style=" display: none;">
